...
namespace AmongUsDiscordIntegration {
    ...
    public class ProcessMemory {
        ...
        public static extern bool ReadProcessMemory(IntPtr hProcess, IntPtr lpBaseAddress, byte[] lpBuffer,
            UIntPtr nSize, out int lpNumberOfBytesRead);
        ...
        [DllImport("kernel32.dll")]
        static extern int VirtualQueryEx(IntPtr hProcess, uint lpAddress, out MEMORY_BASIC_INFORMATION lpBuffer,
            int dwLength);
        ...
        public int Id {
            get { return this.m_Process.Id; }
        }

        public ProcessAccess AccessFlags {
            get { return this.m_ProcessAccess; }
        }

        public bool Opened {
            get { return (this.m_Handle != IntPtr.Zero); }
        }

        #endregion

        public IntPtr MemAlloc(uint size) {
            return MemAlloc(IntPtr.Zero, size, AllocationType.Reserve | AllocationType.Commit,
                MemoryProtection.ExecuteReadWrite);
        }

        public IntPtr MemAlloc(IntPtr baseAddress, uint size, AllocationType allocationType,
        ...
        public struct RemoteThreadParams {
            [MarshalAs(UnmanagedType.I4)] public int Param1;
            [MarshalAs(UnmanagedType.I4)] public int Param2;
        }
        ...
        public float CallFunctionFloat(IntPtr functionPtr, IntPtr param) {
            ...
            byte[] inline = {
                0x68, 0, 0, 0, 0, 0xFF, 0x15, 0, 0, 0, 0, 0xD9, 0x1D, 0, 0, 0, 0, 0xA1, 0, 0, 0, 0, 0x59, 0xC3, 0, 0, 0,
                0, 0, 0, 0, 0
            };
