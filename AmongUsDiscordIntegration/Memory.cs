...
namespace AmongUsDiscordIntegration
{
    ...
    public class Memory
    {
        ...
        public void FreezeValue(string address, string type, string value, string file = "")
        {
            ...
            {
                //Console.WriteLine("Changing Freezing Address " + address + " Value " + value);
                try
                {
                ...
                {
                    //Console.WriteLine("ERROR: Avoided a crash. Address " + address + " was not frozen.");
                }
            }
            else 
                //Console.WriteLine("Adding Freezing Address " + address + " Value " + value);
        ...
        {
            //Console.WriteLine("Un-Freezing Address " + address);
            try
            {
                FreezeTokenSrcs[address].Cancel();
                FreezeTokenSrcs.Remove(address);
            ...
            {
                //Console.WriteLine("ERROR: Address " + address + " was not frozen.");
            }
        }
        ...
        public bool OpenProcess(int pid)
        {
            ...
            try
            {
                ...
                {
                    //Console.WriteLine("ERROR: OpenProcess: Process is not responding or null.");
                    return false;
                }
                ...
                if (pHandle == IntPtr.Zero)
                {
                    ...
                    //Console.WriteLine("ERROR: OpenProcess has failed opening a handle to the target process (GetLastWin32ErrorCode: " + eCode + ")");
                ...
                //Console.WriteLine("Program is operating at Administrative level. Process #" + theProc + " is open and modules are stored.");

                return true;
            }
            catch {
                //Console.WriteLine("ERROR: OpenProcess has crashed. Are you trying to hack a x64 game? https://github.com/erfg12/memory.dll/wiki/64bit-Games");
                return false;
            }
        }
        ...
        public bool OpenProcess(string proc) {
            var procId = GetProcIdFromName(proc);
            return OpenProcess(procId);
        }
        ...
        private int LoadIntCode(string name, string path)
        {
            ...
            {
                //Console.WriteLine("ERROR: LoadIntCode function crashed!");
                return 0;
            }
        }
            ...
            else if (type.ToLower() == "bytes")
            {
                if (write.Contains(",") || write.Contains(" ")) //check if it's a proper array
                {
                    ...
                    if (write.Contains(","))
                        ...
                        stringBytes = write.Split(' ');
                    //Console.WriteLine("write:" + write + " stringBytes:" + stringBytes);
        ...
        public UIntPtr GetCode(string name, string path = "", int size = 8)
        {
            ...
            if (Is64Bit)
            {
                //Console.WriteLine("Changing to 64bit code...");
            ...
            if (theCode == "")
            {
                //Console.WriteLine("ERROR: LoadCode returned blank. NAME:" + name + " PATH:" + path);
                return UIntPtr.Zero;
            }
            else
            {
                //Console.WriteLine("Found code=" + theCode + " NAME:" + name + " PATH:" + path);
            }
            ...
            if (newOffsets.Contains(','))
            {
                ...
                else if (!theCode.Contains("base") && !theCode.Contains("main") && theCode.Contains("+"))
                {
                    ...
                    else
                    {
                        ...
                        {
                            //Console.WriteLine("Module " + moduleName[0] + " was not found in module list!");
            ...
            else // no offsets
            {
                ...
                IntPtr altModule = IntPtr.Zero;
                //Console.WriteLine("newOffsets=" + newOffsets);
        ...
        public Task<IEnumerable<long>> AoBScan(long start, long end, string search, bool readable, bool writable, bool executable, string file = "")
        {
            return Task.Run(() =>
            {
                ...
                //Console.WriteLine("[DEBUG] memory scan starting... (start:0x" + start.ToString(MSize()) + " end:0x" + end.ToString(MSize()) + " time:" + DateTime.Now.ToString("h:mm:ss tt") + ")");
                ...
                //Console.WriteLine("[DEBUG] memory scan completed. (time:" + DateTime.Now.ToString("h:mm:ss tt") + ")");
